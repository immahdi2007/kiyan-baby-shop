...
<body>
    ...
    <header>
        <div class="left-menu header-item">
                ...
                echo '<a href="./userInformation.php" class="buy-cart left"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="36" height="36">
        ...
        <a href="index.php"><h1 class="title header-item">پوشاک کیان</h1></a>
