...
if(isset($_SESSION['cart'][$prd_code])){
    ...
    ?>
<script>alert("محصول به سبد خرید اضافه شد.")</script>

    <div class="order_detail__container">
        <?php
// foreach($_SESSION['cart'] as $item){
?>
        <div class="prd_detail_img_container order">
            ...
            <div class="product_amount">
                <p class="plusNum">+</p>
                <input class="prdStock" type="text" name="prd_amount" id="" value="<?= $item['prd_amount']  ?>">   
                <p class="MinusNum">-</p>
            </div>
            <div>
                <span>مجموع قیمت: 
